...
var spell_sphere = preload("res://src/enemies/attack/night_borne_spell.tscn")
...
func init_spell_sphere():
	var new_spell_sphere = spell_sphere.instantiate()
	new_spell_sphere.set_target(self)
	add_child(new_spell_sphere)
